...
public class Anim {
    ...
    Anim() {
        this.time_animation = 2000; // duration of appearance
    }

    // Function that displays the Game Over image
    ...
    // Function that displays the GIF Win
    ...
    // Function that displays the animated character's GIF
    public void print_toto() {
        ...
        this.image_toto = new Image(getClass().getResourceAsStream("pictures/game/animation/toto.png"));
        ...
        this.picture_mood.setX(
                (this.picture_toto.getX() + (this.image_toto.getWidth() / 2)) - (this.image_mood.getWidth() / 2) + 3);
    ...
    // Function that displays the moods of the character
    public void print_toto_mood(String mood) {
        ...
        if (mood.compareTo("happy") != 0) {
            this.picture_mood.setX((this.picture_toto.getX() + (this.image_toto.getWidth() / 2))
                    - (this.image_mood.getWidth() / 2) + 3);
            this.picture_mood.setY(this.totoY - this.image_mood.getHeight() + 65);
        } else {
            this.picture_mood.setX(
                    (this.picture_toto.getX() + (this.image_toto.getWidth() / 2)) - (this.image_mood.getWidth() / 2));
        ...
        if (mood.compareTo("sad") != 0) // as long as we haven't lost we continue
        {
                        ...
                        public void run() {
                            Platform.runLater(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    image_mood = new Image(
                                            getClass().getResourceAsStream("pictures/game/animation/normal.png"));
                                    picture_mood.setX((picture_toto.getX() + (image_toto.getWidth() / 2))
                                            - (image_mood.getWidth() / 2) + 3);
