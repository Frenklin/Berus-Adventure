...
public class Game {
    ...
    static int difficulty; // represents the number of colors in the bubble cloud
    ...
    // Function that displays the background of the game
    public void print_background() {
        picture_background = new ImageView();
        final Image image1 = new Image(getClass().getResourceAsStream("pictures/game/background/background1.png"));
        picture_background.setX(-30);
        picture_background.setImage(image1);
        game_root.getChildren().add(picture_background);
    }

    // Function that handles game mouse events (mouse movement, click to shoot...)
    ...
    // Function that makes the reset button blink once the game is over
    ...
    // Function that resets the main fields to redo a game
    ...
    // Function that displays the reset button
    ...
    // Function that displays the home button
