...
//Class that manages the barrel and the arrow
public class Canon {
    ...
    // Function that displays barrel, arrow and borderline
    public void print() {
    ...
    // Function that rotates the arrow depending on the position of the cursor
